...
if __name__ == '__main__':
    ...
    with open(run_list) as csvfile:
        # expects file in this format pipe delimited. Hack/Category/Runner has to match hack name on SRC,
        # time in h:mm:ss.SSS, date in YYYY-MM-DD, video can be anything, also expects header
